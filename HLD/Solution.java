...
static int getInvCount(List<Integer> list)
{
    ...
    for (int i = n - 1; i >= 0; i--)
    {
        ...
        invcount += getSum(BIT, list.get(i) - 1);
 
        // Add current element to BIT
        updateBIT(BIT, maxElement, list.get(i), 1);
    }
...
{
    Integer []arr = {8, 4, 2, 1};
    List<Integer> list = Arrays<Integer>.asList(arr);
    int n = arr.length;
